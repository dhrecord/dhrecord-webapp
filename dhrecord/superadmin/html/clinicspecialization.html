        ...
        <div class="container-fluid container">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="./clinicspecialization.html">Clinic Specialization</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="modal fade" id="popupModal5" tabindex="-1" aria-labelledby="popupModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                        <button type="button" onclick="saveDetails5();" class="btn btn-primary">Add Item</button>
                    </div>
                </div>
            </div>
        </div>
