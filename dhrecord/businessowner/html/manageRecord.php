        ...
        <table class="table table-striped">
            ...
            <tbody id="data">
               ...
               <tr>     
                    ...
                    <td><button type="button" class="btn btn-sm btn-danger" onclick="document.location.href='deletePatient.php?UserID=<?php echo $row["users_ID"]; ?>'">Delete</button></td>
                    <td><button type="button" class="btn btn-sm btn-success" onclick="document.location.href='familyTagging.php?ChangeID=<?php echo $row["users_ID"]; ?>'">Family Tagging</button></td>
               </tr>
