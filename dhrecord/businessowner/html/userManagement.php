            ...
            <?php
                ...
                ?>
                    <tr>
                        ...
                        <td><button type="button" class="btn btn-sm btn-success" onclick="document.location.href='deleteUser.php?frontdeskID=<?php echo $row["frontdeskID"]; ?>'">Delete</button></td>
                    </tr>
